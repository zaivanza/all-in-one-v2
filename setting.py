...
def value_debank():
    ...
    # Если какой-то модуль не нужен, закомментируй (#) его. Модуль nft самый долгий, по ненадобности лучше его отключать
    modules = [
...
def value_1inch_swap():
    ...
    return chain, swap_all_balance, min_amount_swap, keep_value_from, keep_value_to, amount_from, amount_to,\
        from_token_address, to_token_address, slippage, divider_zksync
